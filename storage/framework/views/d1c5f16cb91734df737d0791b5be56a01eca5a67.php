                ...
                <div class="w-49prec">
                    <div class="whitebox">
                        <div class="flex flex-wrap between" style="margin-bottom: 20px;">
                            ...
                            <div class="persid">ID: #<?php echo e(Auth::user()->id); ?></div>
                        </div>

                        <form method="POST" action="<?php echo e(route('profile.settings')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="perso-in">
                                ...
                                <div class="pers-buttons">
                                    ...
                                    <a href="<?php echo e(route('profile.index')); ?>" class="bt btn-cancel">Отменить изменения</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="w-49prec">
                    <div class="acc-recepients whitebox">
                        <div class="rec-block">
                            ...
                            <?php $__currentLoopData = Auth::user()->recipients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <form method="" action="">
                                    <div class="confirm-input">
                                        <div class="no-confirm">
                                            <p class="conf-none">
                                                <?php if($recipient->confirm): ?>
                                            ...
                                            <p class="conf-none"
                                               style="border: none;"><?php echo e($recipient->surname); ?> <?php echo e($recipient->name); ?> <?php echo e($recipient->fname); ?></p>
                                        </div>
        ...
        <div class="modal-dialog modal-account">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo e(route('profile.recipients.add')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ibrohim/Backend/php/Laravel/oryx/resources/views/profile/settings.blade.php ENDPATH**/ ?>