...
<html lang="ru">
    <head>
        ...
        <link rel="icon" type="image/ico" href="<?php echo e(asset('admin/images/favicon.png')); ?>">
        <title></title>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('admin/css/style.css?v=0.1')); ?>">
        <link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
        <link rel="stylesheet" href="<?php echo e(asset('admin/css/media.css')); ?>">
    ...
    <?php if(Auth::check()): ?>
            <?php if(View::hasSection('header')): ?>
                <div class="header-wrap">
                    ...
                    <?php echo $__env->make('admin.partials.top', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            <?php else: ?>
                <div class="header-wrap">
                    <div class="header">
            ...
            <script src="<?php echo e(asset('admin/js/dev.js')); ?>"></script>
        <?php else: ?>
            <?php echo $__env->yieldContent('content'); ?>
        <?php endif; ?>
    </body>
</html>
<?php /**PATH /home/ibrohim/Backend/php/Laravel/oryx/resources/views/layouts/admin.blade.php ENDPATH**/ ?>