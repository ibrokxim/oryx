<?php $__env->startSection('header'); ?>
	<div class="header header-recipients">
	    <div class="inner">
            	    ...
            	    <div class="search-wrap">
            	        <form action="" method="">
            	            <div class="search-group">
            	                ...
            	                <input value="<?php echo e(request()->input('s')); ?>" type="text" name="s" placeholder="Найти получателя" class="input-search" />
            	            </div>
            	        </form>
            	    </div>

                    <form action="">
                    	<a class="createuser" href="<?php echo e(route('recipients.create')); ?>">Добавить получателя +</a>
                    </form>
            	</div>
            </div>


    	    <form action="<?php echo e(route('recipients.delete')); ?>" method="POST">
    	    	<?php echo csrf_field(); ?>
    	        <table class="table tablebordered">
    	            <thead>
    	                <tr>
    	                    ...
    	                    <td style="width: 90px;">
    	                        <div class="select-delete nowrap">
    	                    ...
    	                    <td><p class="table-items">Дата отправки</p></td>
    	                    <td><?php echo e(Form::select('status',['Все','Подтвержен','Отклонен','Новый'], request()->input('status',0), ['id'=>'status'])); ?></td>
    	                    <td></td>
    	                    <td></td>
    	                </tr>
    	            </thead>
    	            <tbody>
    	                ...
    	                <tr>
    	                    ...
    	                    <td style="width: 90px;"><?php echo e($item->user_id); ?></td>
    	                    <td style="width: 200px;"><?php echo e($item->user->surname ?? ''); ?> <?php echo e($item->user->name ?? ''); ?> <?php echo e($item->user->fname ?? ''); ?></td>

    	                    <td class="hide"><?php echo e($item->surname); ?> <?php echo e($item->name); ?> <?php echo e($item->fname); ?></td>
    	                    <td><?php echo e($item->created_at->format('d.m.Y / H:i')); ?></td>
    	                    <td>
    	                    	<?php if($item->confirm): ?>
    	                    		Подтвержен
    	                    	<?php elseif($item->registration): ?>
    	                    		Отклонен
    	                    	<?php else: ?>
    	                    		<b>Новый</b>
    	                    	<?php endif; ?>
    	                    ...
    	                    <td>
    	                        <a class="usedit" href="<?php echo e(route('recipients.edit', $item->id)); ?>">
	...
	<script>
		$(function(){
		    ...
		    $('#status').change(function () {
		    	window.location.href = '<?php echo e(route('recipients.index', ['status'=>''])); ?>'+$(this).val();
		    });
		});
	</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ibrohim/Backend/php/Laravel/oryx/resources/views/admin/recipients/index.blade.php ENDPATH**/ ?>