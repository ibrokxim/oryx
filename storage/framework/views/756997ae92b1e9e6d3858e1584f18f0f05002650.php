...
<script src=" <?php echo e(asset('assets/js/slick.js')); ?> " type="text/javascript"></script>

<script src=" <?php echo e(asset('assets/js/bootstrap.min.js')); ?>"></script>
<script src=" <?php echo e(asset('assets/js/slick.js')); ?> "></script>
<script src=" <?php echo e(asset('assets/js/maskedinput.js')); ?> "></script>
...
<?php /**PATH /home/ibrohim/Backend/php/Laravel/oryx/resources/views/components/scripts.blade.php ENDPATH**/ ?>