        	    ...
        	    <div class="flex flex-wrap align-center">
            	    ...
            	    <div class="search-wrap" >
            	        <form action="" method="">
            	            <div class="search-group">
            	                ...
            	                <input value="<?php echo e(request()->input('s')); ?>" type="text" name="s" placeholder="Найти пользователя" class="input-search" />
        	        ...
        	        <div class="buttons-top hide" style="left: 300px;right: auto;">
                		<form action="" id="status">
                        	<?php echo e(Form::select('status', array_replace(['Все статусы'], App\Models\Setting::tariffs()), request()->input('status'))); ?>
                	...
                	<div class="buttons-top">
                        <form action="">
                        	<a class="createuser" href="<?php echo e(route('users.create')); ?>">Добавить пользователя +</a>
                        </form>
                	</div>
        	    </div>
            </div>
    	                ...
    	                <tr>
    	                    ...
    	                    <td>
    	                    	<?php if($item->getMedia('avatars')->first()): ?>
    	                    		<img src="<?php echo e($item->getMedia('avatars')->first()->getUrl('mini-thumb')); ?>" class="users">
    	                    	<?php endif; ?>
    	                    	<?php echo e($item->id); ?>

    	                    </td>
                            <td  style="max-width: 200px;"><?php echo e($item->surname); ?> <?php echo e($item->name); ?> <?php echo e($item->fname); ?></td>
    	                    <td  style="max-width: 200px;"><a href="mailto:<?php echo e($item->email); ?>"><?php echo e($item->email); ?></a></td>
    	                    <td><?php echo e($item->p); ?></td>
    	                    <td class=""><?php echo e($item->tariffObj->name ?? ''); ?></td>
    	                    <td>
    	                        <a class="usedit" href="<?php echo e(route('users.edit', $item->id)); ?>">
    	                        ...
    	                        <a class="usedit hide" href="<?php echo e(route('parcels.index',['s'=>$item->id,'status'=>10])); ?>">Посылки</a>
    	                    </td>

    	                    <td class="hide"><a class="usedit" href="<?php echo e(route('users.referal',$item->id)); ?>">Рефералы</a></td>
    	                </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ibrohim/Backend/php/Laravel/oryx/resources/views/admin/users/index.blade.php ENDPATH**/ ?>