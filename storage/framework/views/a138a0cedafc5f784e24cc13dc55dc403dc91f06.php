                    ...
                    <div class="search-wrap">
                        <form action="" method="GET">
                            <div class="search-group">
                                ...
                                <input value="<?php echo e(request()->input('s')); ?>" type="text" name="s" placeholder="Найти функцию" class="input-search" />
                                <input type="hidden" name="status" value="<?php echo e(request()->input('status')); ?>">
                            </div>
                        </form>
                    </div>
                    <div class="buttons-top">
                        <a class="createuser" href="<?php echo e(route('additional-functions.create')); ?>">Добавить функцию +</a>
                    </div>
                </div>
            </div>
            <div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $addFunction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>

                                <td style="max-width: 200px;"><?php echo e($item->name); ?></td>
                                <td><?php echo e($item->price); ?></td>
                                <td><?php echo e($item->text); ?></td>
                                <td>
                                    <a class="usedit" href="<?php echo e(route('additional-functions.edit', $item->id)); ?>">
                                ...
                                <td>
                                <form action="<?php echo e(route('additional-functions.delete', $item->id)); ?>" method="POST" onsubmit="return confirm('Вы уверены, что хотите удалить этот элемент?');">
                                    <?php echo csrf_field(); ?>
                ...
                <div class="pagination-wrap">
                    <?php echo e($addFunction->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ibrohim/Backend/php/Laravel/oryx/resources/views/admin/additional_functions/index.blade.php ENDPATH**/ ?>