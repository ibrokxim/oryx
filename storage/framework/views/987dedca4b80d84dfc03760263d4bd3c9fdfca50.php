<div class="roles">
	<input type="hidden" class="item-id" name="id[]" value="<?php echo e($item->id); ?>">
    <div class="nameflex">
        <div class="role-1">Роль <span class="title-index"><?php echo e(isset($index)?$index+1:1); ?></span></div>
    ...
    <div class="role-inputs">
        <div class="first-inputs">
            ...
            <input type="text" name="title[]" value="<?php echo e($item->title); ?>" class="role-input"/>
        </div>
    </div>
    <div class="dostup">
        ...
        <div class="selectors">
            ...
            <div class="select-input">
	            ...
	            <div class="others-inputs">
	            	<?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			            <div class="others-flex">
	                    	<div class="razdel"><?php echo e($title); ?></div>
	                       	<input type="checkbox" name="permission<?php echo e(isset($index)?$index:0); ?>[]" class="checks" value="<?php echo e($id); ?>" 
	                       	<?php if($item->id): ?>
				              <?php echo e($item->permissions->contains($id)? 'checked' : ''); ?>
...
</div><?php /**PATH /home/ibrohim/Backend/php/Laravel/oryx/resources/views/admin/roles/form.blade.php ENDPATH**/ ?>