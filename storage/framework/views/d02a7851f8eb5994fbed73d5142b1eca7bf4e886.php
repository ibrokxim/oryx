...
<?php $__env->startSection('content'); ?>
    <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('additional-functions.update', $additionalFunction->id)); ?>">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?> <!-- Используйте метод PUT для обновления -->
                ...
                <div class="profiles">
                    ...
                    <div class="prof-inputs flex flex-wrap">
                        <div class="new-flex w-two">
                            ...
                            <input type="text" name="name" class="input-withid" value="<?php echo e($additionalFunction->name); ?>" placeholder="Введите название" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="new-flex w-two">
                            ...
                            <textarea name="text" style="width: 585px; height: 150px" class="input-withid" placeholder="Введите текст при отображении"><?php echo e($additionalFunction->text); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="new-flex w-two">
                            ...
                            <input type="text" name="price" class="input-withid" value="<?php echo e($additionalFunction->price); ?>" placeholder="Введите цену" />
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ibrohim/Backend/php/Laravel/oryx/resources/views/admin/additional_functions/edit.blade.php ENDPATH**/ ?>