            ...
            <div class="parcels-menu">
                <div class="parcels-menublock">
                    <div class="transact-nav mb-50px">
                        <a class="transact-link" href="<?php echo e(route('profile.addresses')); ?>">США</a>
            ...
            <div class="content-adresses">
                ...
                <div class="country-wrap flex flex-wrap between">
                    ...
                    <div class="parcels-inputs">
                        <a href="<?php echo e(route('profile.parcels.create')); ?>" class="bt btn-orange add-parcel">Добавить
                            посылку</a>
                    </div>
                </div>
                        ...
                        <div class="adresses-flex_wrap flex flex-wrap between">
                            ...
                            <div class="adresses-flex adresinput">
                                <div class="adresses-info">
                                    ...
                                    <p class="adress-ex"><input type="text" disabled
                                                                value="<?php echo e($addr[0]); ?> <?php echo e(Auth::user()->address); ?>"></p>
                                </div>
                                <div class="copy">
                            ...
                            <div class="adresses-flex adresinput">
                                <div class="adresses-info">
                                    ...
                                    <p class="adress-ex"><input type="text" disabled
                                                                value="<?php echo e(auth()->user()->id); ?>"></p>
                                </div>
                                <div class="copy">
                            ...
                            <div class="adresses-flex">
                                <div class="adresses-info">
                                    ...
                                    <p class="adress-ex"><input type="text" disabled value="<?php echo e($addr[2]); ?>"></p>
                                </div>
                                <div class="copy">
                            ...
                            <div class="adresses-flex">
                                <div class="adresses-info">
                                    ...
                                    <p class="adress-ex"><input type="text" disabled value="<?php echo e($addr[3]); ?>"></p>
                                </div>
                                <div class="copy">
                            ...
                            <div class="adresses-flex">
                                <div class="adresses-info">
                                    ...
                                    <p class="adress-ex"><input type="text" disabled value="<?php echo e($addr[4]); ?>"></p>
                                </div>
                                <div class="copy">
                            ...
                            <div class="adresses-flex">
                                <div class="adresses-info">
                                    ...
                                    <p class="adress-ex"><input type="text" disabled value="<?php echo e($addr[5]); ?>"></p>
                                </div>
                                <div class="copy">
                            ...
                            <div class="adresses-flex">
                                <div class="adresses-info">
                                    ...
                                    <p class="adress-ex"><input type="text" disabled value="<?php echo e($addr[6]); ?>"></p>
                                </div>
                                <div class="copy">
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/oryx.kz/cms.oryx.kz/resources/views/profile/addresses_eu.blade.php ENDPATH**/ ?>