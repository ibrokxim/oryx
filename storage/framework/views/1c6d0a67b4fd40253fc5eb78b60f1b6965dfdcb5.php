...
<?php $__env->startSection('content'); ?>
    <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('additional-functions.store')); ?>">
        <?php echo csrf_field(); ?>
                ...
                <div class="profiles">
                    ...
                    <div class="prof-inputs flex flex-wrap">
                        ...
                        <div class="new-flex w-two">
                            ...
                            <input type="text" name="name" class="input-withid"  placeholder="Введите название" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="new-flex w-two">
                            ...
                            <textarea name="text" style="width: 585px; height: 150px" class="input-withid" placeholder="Введите текст при отображении"></textarea>
                            <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ibrohim/Backend/php/Laravel/oryx/resources/views/admin/additional_functions/create.blade.php ENDPATH**/ ?>