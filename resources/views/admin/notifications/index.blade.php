...
@section('content')
	<div class="buttons-top">
        <form action="">
        	<a class="createuser" href="{{route('notifications.create')}}">Добавить уведомлениe +</a>
        </form>
	</div>
	        ...
	        <table class="table tablebordered">
	            ...
	            <tbody>
	                ...
	                <tr>
	                    ...
	                    <td>{{$item->name}}</td>
	                    <td>
	                    	<p class="notifications-content">{!! $item->value !!}</p>
	                          <div class="notifications-links">
	                              <a class="edit" href="{{route('notifications.edit', $item->id)}}">Редактировать</a>
	                              <span>|</span>
	                              <button class="delete" type="button" data-id="{{$item->id}}">Удалить</button>
	                          </div>
	                    	</td>
	                    <td>{{$item->active?'Активно':'Неактивно'}}</td>
	                </tr>
	                @endforeach
	            </tbody>
	        </table>
