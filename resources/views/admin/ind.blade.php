...
@section('header')
	<div class="header header-users" style="top: 0">
	    <div class="inner">
	        <div class="logo"><img src="{{env('ASSETS')}}/admin/images/logo.png"></div>
...
@section('content')
	...
	<div class="buttons-top">
	    <form>
	    	<a class="createuser" href="{{route('ind.load',request()->except('status'))}}" style="margin-left: 10px;">Скачать</a>
	    </form>
	</div>
	                ...
	                <tr>
	                    ...
	                    <td>
	                        ...
	                        <div class="parcels-links">
	                            <a class="edit" href="{{route('parcels.edit', $item->id)}}">Редактировать посылку</a>
	                        </div>
	                    </td>
	                    <td>{{$item->in_city ?? '' }}</td>
	                    <td>{{$item->weight}}</td>
